...
void setup() {
  ...
  LeftPaddle.updateSetup(PongTable.CenterlineX,3,PongTable.CenterlineY_Top,PongTable.CenterlineY_Bottom,0,0,0,0,0,0,0);
  RightPaddle.updateSetup(PongTable.CenterlineX,3,PongTable.CenterlineY_Top,PongTable.CenterlineY_Bottom,0,0,0,0,0,0,0);
